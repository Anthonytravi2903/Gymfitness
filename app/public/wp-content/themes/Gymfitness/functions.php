...
// Menus de navegacion, agrgar mas utilizando el arreglo el arreglo
function gymfitness_menu() {
register_nav_menus(array(
'menu-principal'=>__('Menu Principal', 'gymnfitness')
));
}
...
register_sidebar(array(
    ...
    'after_widget' => '</div>',
    'before_tittle' => '<h3 class="text-center texto-primario">',
    'after_title' =>'</h3>'
));
register_sidebar(array(
    'name' => 'Sidebar 2',
...
function gymfitness_hero_image(){
    //Obtener ID principal de la pagina//
